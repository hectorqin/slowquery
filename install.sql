...
CREATE TABLE `mysql_slow_query_review_history` (
  ...
  `checksum` char(32) NOT NULL,
  `sample` longtext NOT NULL,
  `ts_min` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
  `ts_max` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
  ...
  KEY `idx_serverid_max` (`serverid_max`),
  KEY `idx_checksum` (`checksum`),
  KEY `idx_query_time_max` (`Query_time_max`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
